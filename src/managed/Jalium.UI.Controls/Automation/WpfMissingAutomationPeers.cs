...
public class DocumentViewerBaseAutomationPeer : FrameworkElementAutomationPeer
{
    ...
    protected override AutomationControlType GetAutomationControlTypeCore() => AutomationControlType.Document;
    protected override string GetClassNameCore() => nameof(DocumentViewerBase);
}
...
public class DateTimeAutomationPeer : AutomationPeer, IInvokeProvider, Jalium.UI.Automation.ISelectionItemProvider
{
