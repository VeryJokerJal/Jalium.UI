...
public abstract class SelectorAutomationPeer : ItemsControlAutomationPeer,
    Jalium.UI.Automation.ISelectionProvider,
...
public class SelectorItemAutomationPeer : ItemAutomationPeer,
    Jalium.UI.Automation.ISelectionItemProvider,
...
public class TextAutomationPeer : FrameworkElementAutomationPeer
{
    public TextAutomationPeer(FrameworkElement owner)
        : base(owner)
    {
    }
}
