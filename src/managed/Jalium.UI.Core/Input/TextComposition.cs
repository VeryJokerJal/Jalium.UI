...
/// <summary>
/// Represents a text-input composition used for IME and keyboard processing.
/// </summary>
public class TextComposition : DispatcherObject
{
    ...
    private string _systemCompositionText = string.Empty;
    ...
    {
        get => _resultText;
        protected set => _resultText = value ?? string.Empty;
    }
    ...
    {
        get => _systemText;
        protected set => _systemText = value ?? string.Empty;
    }
    ...
    {
        get => _controlText;
        protected set => _controlText = value ?? string.Empty;
    }
    ...
    public string CompositionText
    {
        ...
        protected set => _compositionText = value ?? string.Empty;
    }

    /// <summary>
    /// Gets or sets the composition portion of system text, such as an active
    /// Alt-key composition.
    /// </summary>
#pragma warning disable CS3021 // The attribute is part of the WPF public contract.
    [CLSCompliant(false)]
    public string SystemCompositionText
    {
        get => _systemCompositionText;
        protected set => _systemCompositionText = value ?? string.Empty;
    }
#pragma warning restore CS3021
    ...
    internal void ClearTexts()
    {
        ...
        _systemCompositionText = string.Empty;
    }
...
/// </summary>
public sealed partial class TextCompositionManager : Jalium.UI.Threading.DispatcherObject
{
