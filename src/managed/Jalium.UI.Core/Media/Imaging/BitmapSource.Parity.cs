...
/// <summary>
/// Canonical WPF-compatible bitmap source surface.
/// </summary>
public abstract partial class BitmapSource
{
    ...
    public virtual void CopyPixels(Int32Rect sourceRect, Array pixels, int stride, int offset)
    {
        ...
        {
            CopyPixels(sourceRect, bytes, stride, offset);
            return;
        }

        int byteLength = Buffer.ByteLength(pixels);
        var buffer = new byte[byteLength];
        CopyPixels(sourceRect, buffer, stride, offset);
    ...
    public virtual void CopyPixels(Int32Rect sourceRect, IntPtr buffer, int bufferSize, int stride)
    {
        ...
        CopyPixels(sourceRect, pixels, stride, 0);
