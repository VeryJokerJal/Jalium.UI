...
public sealed class RenderTargetBitmap : Jalium.UI.Media.RenderTargetBitmap
{
    public RenderTargetBitmap(int pixelWidth, int pixelHeight, double dpiX, double dpiY, PixelFormat pixelFormat)
        : base(pixelWidth, pixelHeight, dpiX, dpiY, pixelFormat)
    {
    }

    /// <summary>Clears the render target to transparent pixels.</summary>
    public void Clear() => base.Clear(Color.FromArgb(0, 0, 0, 0));
...
public sealed class WriteableBitmap : Jalium.UI.Media.WriteableBitmap
{
    public WriteableBitmap(
        ...
        : base(pixelWidth, pixelHeight, dpiX, dpiY, pixelFormat, palette)
    {
    }
    ...
    public bool TryLock(Duration timeout)
    {
        ...
        return base.TryLock(timeout.TimeSpan);
    }
