...
public static class JalxamlParser
{
    ...
    private static readonly Dictionary<string, string> TypeMappings = new(StringComparer.Ordinal)
    {
        ...
        { "ElementBlurEffect", "Jalium.UI.Media.Effects.ElementBlurEffect" },
        { "OuterGlowEffect", "Jalium.UI.Media.Effects.OuterGlowEffect" },
        { "InnerShadowEffect", "Jalium.UI.Media.Effects.InnerShadowEffect" },
        { "EmbossEffect", "Jalium.UI.Media.Effects.EmbossEffect" },
        { "ColorMatrixEffect", "Jalium.UI.Media.Effects.ColorMatrixEffect" },
        { "ColorMatrix", "Jalium.UI.Media.Effects.ColorMatrix" },
        { "EffectGroup", "Jalium.UI.Media.Effects.EffectGroup" },
        { "EffectCollection", "Jalium.UI.Media.Effects.EffectCollection" },
        { "PixelShader", "Jalium.UI.Media.Effects.PixelShader" },
        { "BlurBitmapEffect", "Jalium.UI.Media.Effects.BlurBitmapEffect" },
        { "DropShadowBitmapEffect", "Jalium.UI.Media.Effects.DropShadowBitmapEffect" },
        { "BevelBitmapEffect", "Jalium.UI.Media.Effects.BevelBitmapEffect" },
        { "EmbossBitmapEffect", "Jalium.UI.Media.Effects.EmbossBitmapEffect" },
        { "OuterGlowBitmapEffect", "Jalium.UI.Media.Effects.OuterGlowBitmapEffect" },
        { "BitmapEffectGroup", "Jalium.UI.Media.Effects.BitmapEffectGroup" },
        { "BitmapEffectCollection", "Jalium.UI.Media.Effects.BitmapEffectCollection" },
        { "BitmapEffectInput", "Jalium.UI.Media.Effects.BitmapEffectInput" },
        { "BackdropBlurEffect", "Jalium.UI.Media.BackdropBlurEffect" },
        { "AcrylicEffect", "Jalium.UI.Media.AcrylicEffect" },
        { "MicaEffect", "Jalium.UI.Media.MicaEffect" },
        { "FrostedGlassEffect", "Jalium.UI.Media.FrostedGlassEffect" },
        { "ColorAdjustmentEffect", "Jalium.UI.Media.ColorAdjustmentEffect" },
        { "CompositeBackdropEffect", "Jalium.UI.Media.CompositeBackdropEffect" },
