...
public class AnimationCompositionPropertyParityTests
{
    ...
    public void AnimationTimeline_DeclaresSharedCompositionDependencyPropertiesOnly()
    {
        ...
        Assert.Null(typeof(AnimationTimeline<double>).GetProperty("IsAdditive", instanceDeclared));
        Assert.Null(typeof(AnimationTimeline<double>).GetProperty("IsCumulative", instanceDeclared));
    }
...
public class FromToByCompositionWpfParityTests
{
...
public class KeyFrameCompositionWpfParityTests
{
    private const long T0 = 1_000_000_000;
...
public class AnimationClockWpfParityTests
{
    private const long T0 = 1_000_000_000;
