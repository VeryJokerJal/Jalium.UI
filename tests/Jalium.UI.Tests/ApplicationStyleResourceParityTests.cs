...
public sealed class ApplicationStyleResourceParityTests
{
    [Fact]
    ...
    public void DispatcherUnhandledException_AddAndRemoveForwardToApplicationDispatcher()
    {
        ...
        try
        {
            ...
            var legacyDispatcher = app.Dispatcher.CoreDispatcher;
            var dispatcherEventField = legacyDispatcher.GetType().GetField(
                nameof(Dispatcher.UnhandledException),
