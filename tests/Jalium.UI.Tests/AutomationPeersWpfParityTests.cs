...
public sealed class AutomationPeersWpfParityTests
{
    [Fact]
    ...
    [Fact]
    public void ChildrenCache_CanBeResetAfterVisualTreeMutation()
    {
        var root = new Grid();
        root.Children.Add(new Button());
        var peer = new GenericRootAutomationPeer(root);
