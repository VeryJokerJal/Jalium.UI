...
public sealed class AutomationProviderFinalGapParityTests
{
    [Fact]
    ...
    public void DataGridProviders_WorkForUnrealizedCellsHeadersAndSelection()
    {
        ...
        AutomationPeer rowPeer = Assert.Single(peer.GetChildren());
        var selectionItem = Assert.IsAssignableFrom<Raw.ISelectionItemProvider>(
            rowPeer.GetPattern(PatternInterface.SelectionItem));
