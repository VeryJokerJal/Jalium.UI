...
public sealed class DataGridRowCellWpfParityTests
{
    [Fact]
    public void CanonicalTemplateTypes_UseTheWpfControlsNamespace_WithRootCompatibilityTypes()
    {
        ...
        Assert.True(typeof(ControlsDataTemplateSelector).IsAssignableFrom(typeof(Jalium.UI.DataTemplateSelector)));
        Assert.True(typeof(ControlsItemsPanelTemplate).IsAssignableFrom(typeof(Jalium.UI.ItemsPanelTemplate)));
