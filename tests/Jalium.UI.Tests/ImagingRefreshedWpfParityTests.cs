...
public sealed class ImagingRefreshedWpfParityTests
{
    [Fact]
    public void CanonicalBitmapTypesLiveInImagingNamespaceAndRetainLegacyRuntimeInheritance()
    {
        ...
        Assert.True(typeof(Jalium.UI.Media.BitmapSource).IsAssignableFrom(typeof(BitmapSource)));
