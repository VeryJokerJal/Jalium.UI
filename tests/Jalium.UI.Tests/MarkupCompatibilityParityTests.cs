...
public sealed class MarkupCompatibilityParityTests
{
    [Fact]
    public void CanonicalAttributesRetainConstructorMetadata()
    {
        ...
        Type[] exported = typeof(CanonicalContentPropertyAttribute).Assembly.GetExportedTypes();
        Assert.DoesNotContain(exported, type => type.FullName == "Jalium.UI.ContentPropertyAttribute");
        Assert.DoesNotContain(exported, type => type.FullName == "Jalium.UI.DesignerSerializationOptions");
        Assert.DoesNotContain(exported, type => type.FullName == "Jalium.UI.DesignerSerializationOptionsAttribute");
        Assert.DoesNotContain(exported, type => type.FullName == "Jalium.UI.Controls.LocalizabilityAttribute");
        Assert.DoesNotContain(exported, type => type.FullName == "Jalium.UI.Controls.LocalizationCategory");
        Assert.DoesNotContain(exported, type => type.FullName == "Jalium.UI.Controls.Readability");
        Assert.DoesNotContain(exported, type => type.FullName == "Jalium.UI.Controls.Modifiability");
        Assert.Contains(exported, type => type.FullName == "Jalium.UI.LocalizabilityAttribute");
        Assert.Contains(exported, type => type.FullName == "Jalium.UI.LocalizationCategory");
        Assert.Contains(exported, type => type.FullName == "Jalium.UI.Readability");
        Assert.Contains(exported, type => type.FullName == "Jalium.UI.Modifiability");

        Type[] localizerExported = typeof(Jalium.UI.Markup.Localizer.BamlLocalizer)
            .Assembly
            .GetExportedTypes();
        Assert.DoesNotContain(localizerExported,
            type => type.FullName == "Jalium.UI.Markup.Localizer.LocalizabilityAttribute");
    }
