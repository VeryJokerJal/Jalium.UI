...
public class MenuBaseParityTests
{
    [Fact]
    public void Menu_DerivesFromCanonicalMenuBase()
    {
        Assert.Equal(typeof(MenuBase), typeof(Menu).BaseType);
        Assert.Null(typeof(Menu).GetProperty(
