...
[CollectionDefinition(nameof(ParityFoundationBehaviorCollection), DisableParallelization = true)]
public sealed class ParityFoundationBehaviorCollection;

[Collection(nameof(ParityFoundationBehaviorCollection))]
public class ParityFoundationBehaviorTests
{
