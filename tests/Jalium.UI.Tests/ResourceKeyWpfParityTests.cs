...
public sealed class ResourceKeyWpfParityTests
{
    [Fact]
    public void ResourceKeyIsAMarkupExtensionThatProvidesItself()
    {
        var key = new ComponentResourceKey(typeof(ResourceKeyWpfParityTests), "Accent");
        ...
        Assert.Equal(typeof(ResourceKeyWpfParityTests).Assembly, key.Assembly);
