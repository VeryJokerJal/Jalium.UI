...
public sealed class SystemXamlInfrastructureWpfParityTests
{
    [Fact]
    public void AttachablePropertyServicesKeepsWeakPerInstanceStores()
    {
        ...
        var property = new AttachableMemberIdentifier(typeof(SystemXamlInfrastructureWpfParityTests), "Label");
