...
public sealed class ThreadingDispatcherWpfParityTests
{
    [Fact]
    public void CanonicalDispatcherSharesTheEstablishedPerThreadQueue()
    {
        Jalium.UI.Dispatcher legacy = Jalium.UI.Dispatcher.GetForCurrentThread();
        ...
        Assert.Same(legacy.Thread, dispatcher.Thread);
