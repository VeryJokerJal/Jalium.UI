...
public sealed class ToolBarWpfParityTests
{
    [Fact]
    ...
    public void OverflowModesReparentItemsDuringMeasureAndKeepMainPanelCompact()
    {
        ...
        Assert.Equal(new UIElement[] { asNeeded, always }, overflowPanel.Children.ToArray());
        ...
        toolBar.Measure(new Size(100, 30));
        Assert.Equal(new UIElement[] { never, asNeeded }, mainPanel.Children.ToArray());
